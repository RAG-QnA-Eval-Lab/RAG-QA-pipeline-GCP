...
![RAG-QA Pipeline Architecture](docs/rag-qa-architecture.jpeg)
...
4. QA 생성: 정책 원본 → GPT-4o-mini 자동 생성 → `data/eval/qa_pairs.json` (100쌍 완료)
5. 평가 (예정): QA 데이터셋 × 모델 × 전략 → 3단계 평가 → JSON 리포트
